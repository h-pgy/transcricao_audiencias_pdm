...
AZURE_STORAGE_AUDIO_CONTAINER_NAME: str = load_env_var("AZURE_STORAGE_AUDIO_CONTAINER_NAME")
AZURE_STORAGE_TRANSCRIPTIONS_CONTAINER_NAME: str = load_env_var("AZURE_STORAGE_TRANSCRIPTIONS_CONTAINER_NAME")
COOKIES_FILE_NAME: str = load_env_var("COOKIES_FILE_NAME")